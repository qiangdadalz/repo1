    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <img id="imageCode" src="${pageContext.request.contextPath }/imageCode" title="看不清？点击换一张" onclick="changeImage()"/>
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    function changeImage(){
        ...
        code.src="${pageContext.request.contextPath }/imageCode"+"?"+Math.random();
    }
</script>
</body>
</html>
